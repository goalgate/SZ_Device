...
//                            CloseDoorRecord(TimeUtils.getNowString());
    ...
    private void CloseDoorRecord(String time) {
        ...
        RetrofitGenerator.getGdyzbConnectApi().withDataRs("closeDoorRecord", config.getString("key"), CloseDoorRecordJson.toString())
    ...
    private void alarmRecord() {
        ...
        RetrofitGenerator.getGdyzbConnectApi().withDataRs("alarmRecord", config.getString("key"), alarmRecordJson.toString())
    ...
    private void StateRecord() {
        ...
        RetrofitGenerator.getGdyzbConnectApi().withDataRs("stateRecord", config.getString("key"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<String>() {
