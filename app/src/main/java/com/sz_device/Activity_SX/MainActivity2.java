...
//
//public class MainActivity2 extends FunctionActivity implements NormalWindow.OptionTypeListener, SuperWindow.OptionTypeListener {
//
...
//                normalWindow = new NormalWindow(MainActivity2.this);
//                normalWindow.setOptionTypeListener(MainActivity2.this);
...
//                superWindow = new SuperWindow(MainActivity2.this);
//                superWindow.setOptionTypeListener(MainActivity2.this);
...
//
//    void openService() {
//        intent = new Intent(MainActivity2.this, SwitchService.class);
//        startService(intent);
//    }
//
...
//            new AlertView("设备信息同步", null, "取消", new String[]{"确定"}, null, MainActivity2.this, AlertView.Style.Alert, new OnItemClickListener() {
//                @Override
...
//            new AlertView("删除人员指纹信息", null, "取消", new String[]{"确定"}, null, MainActivity2.this, AlertView.Style.Alert, new OnItemClickListener() {
//                @Override
//                public void onItemClick(Object o, int position) {
//                    if (position == 0) {
...
//            @Override
//            public void onSucc() {
//                Alarm.getInstance(MainActivity2.this).networkAlarm(network_state, new Alarm.networkCallback() {
//                    @Override
...
//                    @Override
//                    public void onTextBack(String msg) {
//                        Alarm.getInstance(MainActivity2.this).setKnown(true);
//                        tv_info.setText(msg);
//                    }
//                });
//
