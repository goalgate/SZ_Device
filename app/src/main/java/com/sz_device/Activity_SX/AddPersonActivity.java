...
//    @OnClick(R.id.btn_query)
//    void queryPerson() {
//        RetrofitGenerator.getShaoXingApi().queryPersonInfo("queryPersonInfo", config.getString("key"), et_idcard.getText().toString().toUpperCase())
//                .subscribeOn(Schedulers.io())
//                .unsubscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new MyObserver<ResponseBody>(this) {
...
//                JSONObject jsonObject = new JSONObject();
//                try {
//                    jsonObject.put("id", user.getCardId());  //人员身份证ID   String
//                    jsonObject.put("courIds", user.getCourIds());  //人员数据库ID  String
//                    jsonObject.put("dataType", "1");  //新增/修改,默认为1，可无视  String
//                    jsonObject.put("name", user.getName());  //人员姓名  String
//                    jsonObject.put("courType", user.getCourType());  //人员身份类型  String
//                    jsonObject.put("fingerprintPhoto", user.getFingerprintPhoto()); //指纹照片  String
//                    jsonObject.put("fingerprintId", user.getFingerprintId());  //指纹号ID  String
//                    jsonObject.put("fingerprintKey", fpp.fpUpTemlate(user.getFingerprintId()));  //指纹模板  String
//                    jsonObject.put("datetime", TimeUtils.getNowString()); //当前时间  String
//                } catch (JSONException e) {
//                    e.printStackTrace();
//                }
