...
public class SwitchService extends Service implements ISwitchView {
    ...
    private void reUpload() {
        ...
        for (final ReUploadBean bean : list) {
            RetrofitGenerator.getCommonApi().withDataRs(bean.getMethod(), config.getString("key"), bean.getContent())
...
//        }).start();
    ...
    private void CloseDoorRecord(String time) {
        ...
        RetrofitGenerator.getCommonApi().withDataRs("closeDoorRecord", config.getString("key"), CloseDoorRecordJson.toString())
    ...
    private void alarmRecord() {
        ...
        RetrofitGenerator.getCommonApi().withDataRs("alarmRecord", config.getString("key"), alarmRecordJson.toString())
    ...
    private void StateRecord() {
        ...
        RetrofitGenerator.getCommonApi().withDataRs("stateRecord", config.getString("key"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<String>() {
    ...
    private void testNet() {
        RetrofitGenerator.getCommonApi().noData("testNet", config.getString("key"))
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<String>() {
