    ...
    void commit() {
        if (commitable) {
            if (user.getFingerprintId() != null) {
                ...
                RetrofitGenerator.getZjyjbApi().withDataRr("fingerLog", config.getString("key"), jsonObject.toString())
...
//            e.printStackTrace();
//        }
//        RetrofitGenerator.getZjyjbApi().withDataRs("openDoorRecord", config.getString("key"), OpenDoorjson.toString())
//                .subscribeOn(Schedulers.io())
//                .unsubscribeOn(Schedulers.io())
//                .observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new MyObserver<ResponseBody>(this) {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        try {
                            ...
                            Map<String, String> infoMap = new Gson().fromJson(s,
