...
public class ShaoXingActivity extends FunctionActivity implements NormalWindow.OptionTypeListener, SuperWindow.OptionTypeListener {
...
//        SwitchPresenter.getInstance().buzz(SwitchImpl.Hex.H2);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        alert_password.PasswordViewInit(new Alert_Password.Callback() {
            ...
            public void normal_call() {
                normalWindow = new NormalWindow(ShaoXingActivity.this);
                normalWindow.setOptionTypeListener(ShaoXingActivity.this);
            ...
            public void super_call() {
                superWindow = new SuperWindow(ShaoXingActivity.this);
                superWindow.setOptionTypeListener(ShaoXingActivity.this);
    ...
    void openService() {
        intent = new Intent(ShaoXingActivity.this, ShaoXingService.class);
        startService(intent);
    }
    ...
    public void onSuperOptionType(Button view, int type) {
        ...
        if (type == 1) {
            ...
            new AlertView("设备信息同步", null, "取消", new String[]{"确定"}, null, ShaoXingActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
            ...
            new AlertView("删除人员指纹信息", null, "取消", new String[]{"确定"}, null, ShaoXingActivity.this, AlertView.Style.Alert, new OnItemClickListener() {
                @Override
                public void onItemClick(Object o, int position) {
                    if (position == 0) {
    ...
    public void onFpSucc(final String msg) {
        Alarm.getInstance(this).doorAlarm(new Alarm.doorCallback() {
            ...
            @Override
            public void onSucc() {
                Alarm.getInstance(ShaoXingActivity.this).networkAlarm(network_state, new Alarm.networkCallback() {
                    @Override
                    ...
                    @Override
                    public void onTextBack(String msg) {
                        Alarm.getInstance(ShaoXingActivity.this).setKnown(true);
                        tv_info.setText(msg);
                    }
                });
...
//            unknownUser.setFingerprintId(sp);
    ...
    private void iccard_operation(ICardInfo cardInfo) {
        ...
        RetrofitGenerator.getShaoXingApi().withDataRr("searchICKBd", config.getString("key"), jsonObject.toString())
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new MyObserver<ResponseBody>(this) {
